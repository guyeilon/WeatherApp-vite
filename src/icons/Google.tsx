...
const SvgGoogle = (props: SVGProps<SVGSVGElement>) => (
  <svg width="1em" height="1em" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M15 30c4.05 0 7.445-1.344 9.927-3.634l-4.848-3.764c-1.343.9-3.061 1.432-5.08 1.432-3.906 0-7.213-2.639-8.392-6.184H1.595v3.886C4.063 26.638 9.136 30 15 30z"
      fill="#34A853"
    />
    <path
      fillRule="evenodd"
